...
) {.cdecl, importc: "hb_version", dynlib: hbLib.}

proc hb_version_string*(): cstring {.
  cdecl, importc: "hb_version_string", dynlib: hbLib
.}

proc hb_version_atleast*(
  major, minor, micro: cint
): HbBool {.cdecl, importc: "hb_version_atleast", dynlib: hbLib.}

proc hb_tag_from_string*(
  str: cstring, len: cint
): HbTag {.cdecl, importc: "hb_tag_from_string", dynlib: hbLib.}

proc hb_tag_to_string*(
  tag: HbTag, buf: cstring
) {.cdecl, importc: "hb_tag_to_string", dynlib: hbLib.}

proc hb_direction_from_string*(
  str: cstring, len: cint
): HbDirection {.cdecl, importc: "hb_direction_from_string", dynlib: hbLib.}

proc hb_direction_to_string*(
  direction: HbDirection
): cstring {.cdecl, importc: "hb_direction_to_string", dynlib: hbLib.}

proc hb_language_from_string*(
  str: cstring, len: cint
): HbLanguage {.cdecl, importc: "hb_language_from_string", dynlib: hbLib.}

proc hb_language_to_string*(
  language: HbLanguage
): cstring {.cdecl, importc: "hb_language_to_string", dynlib: hbLib.}

proc hb_language_get_default*(): HbLanguage {.
  cdecl, importc: "hb_language_get_default", dynlib: hbLib
.}

proc hb_language_matches*(
  language, specific: HbLanguage
): HbBool {.cdecl, importc: "hb_language_matches", dynlib: hbLib.}

proc hb_script_from_iso15924_tag*(
  tag: HbTag
): HbScript {.cdecl, importc: "hb_script_from_iso15924_tag", dynlib: hbLib.}

proc hb_script_from_string*(
  str: cstring, len: cint
): HbScript {.cdecl, importc: "hb_script_from_string", dynlib: hbLib.}

proc hb_script_to_iso15924_tag*(
  script: HbScript
): HbTag {.cdecl, importc: "hb_script_to_iso15924_tag", dynlib: hbLib.}
...
) {.cdecl, importc: "hb_feature_to_string", dynlib: hbLib.}
...
): HbBlob {.cdecl, importc: "hb_blob_create", dynlib: hbLib.}
...
proc hb_blob_create_or_fail*(
  ...
  userData: pointer,
  destroy: HbDestroyFunc,
): HbBlob {.cdecl, importc: "hb_blob_create_or_fail", dynlib: hbLib.}

proc hb_blob_create_from_file*(
  fileName: cstring
): HbBlob {.cdecl, importc: "hb_blob_create_from_file", dynlib: hbLib.}

proc hb_blob_create_from_file_or_fail*(
  fileName: cstring
): HbBlob {.cdecl, importc: "hb_blob_create_from_file_or_fail", dynlib: hbLib.}

proc hb_blob_create_sub_blob*(
  parent: HbBlob, offset, length: cuint
): HbBlob {.cdecl, importc: "hb_blob_create_sub_blob", dynlib: hbLib.}

proc hb_blob_get_empty*(): HbBlob {.cdecl, importc: "hb_blob_get_empty", dynlib: hbLib.}
proc hb_blob_reference*(
  blob: HbBlob
): HbBlob {.cdecl, importc: "hb_blob_reference", dynlib: hbLib.}

proc hb_blob_destroy*(blob: HbBlob) {.cdecl, importc: "hb_blob_destroy", dynlib: hbLib.}
proc hb_blob_get_length*(
  blob: HbBlob
): cuint {.cdecl, importc: "hb_blob_get_length", dynlib: hbLib.}

proc hb_blob_get_data*(
  blob: HbBlob, length: ptr cuint
): cstring {.cdecl, importc: "hb_blob_get_data", dynlib: hbLib.}

proc hb_blob_make_immutable*(
  blob: HbBlob
) {.cdecl, importc: "hb_blob_make_immutable", dynlib: hbLib.}

proc hb_blob_is_immutable*(
  blob: HbBlob
): HbBool {.cdecl, importc: "hb_blob_is_immutable", dynlib: hbLib.}

proc hb_face_count*(
  blob: HbBlob
): cuint {.cdecl, importc: "hb_face_count", dynlib: hbLib.}

proc hb_face_create*(
  blob: HbBlob, index: cuint
): HbFace {.cdecl, importc: "hb_face_create", dynlib: hbLib.}

proc hb_face_create_or_fail*(
  blob: HbBlob, index: cuint
): HbFace {.cdecl, importc: "hb_face_create_or_fail", dynlib: hbLib.}

proc hb_face_create_from_file_or_fail*(
  fileName: cstring, index: cuint
): HbFace {.cdecl, importc: "hb_face_create_from_file_or_fail", dynlib: hbLib.}

proc hb_face_get_empty*(): HbFace {.cdecl, importc: "hb_face_get_empty", dynlib: hbLib.}
proc hb_face_reference*(
  face: HbFace
): HbFace {.cdecl, importc: "hb_face_reference", dynlib: hbLib.}

proc hb_face_destroy*(face: HbFace) {.cdecl, importc: "hb_face_destroy", dynlib: hbLib.}
proc hb_face_reference_table*(
  face: HbFace, tag: HbTag
): HbBlob {.cdecl, importc: "hb_face_reference_table", dynlib: hbLib.}

proc hb_face_reference_blob*(
  face: HbFace
): HbBlob {.cdecl, importc: "hb_face_reference_blob", dynlib: hbLib.}

proc hb_face_get_index*(
  face: HbFace
): cuint {.cdecl, importc: "hb_face_get_index", dynlib: hbLib.}

proc hb_face_get_upem*(
  face: HbFace
): cuint {.cdecl, importc: "hb_face_get_upem", dynlib: hbLib.}

proc hb_face_get_glyph_count*(
  face: HbFace
): cuint {.cdecl, importc: "hb_face_get_glyph_count", dynlib: hbLib.}

proc hb_font_create*(
  face: HbFace
): HbFont {.cdecl, importc: "hb_font_create", dynlib: hbLib.}

proc hb_font_get_empty*(): HbFont {.cdecl, importc: "hb_font_get_empty", dynlib: hbLib.}
proc hb_font_reference*(
  font: HbFont
): HbFont {.cdecl, importc: "hb_font_reference", dynlib: hbLib.}

proc hb_font_destroy*(font: HbFont) {.cdecl, importc: "hb_font_destroy", dynlib: hbLib.}
proc hb_font_get_face*(
  font: HbFont
): HbFace {.cdecl, importc: "hb_font_get_face", dynlib: hbLib.}

proc hb_font_set_scale*(
  font: HbFont, xScale, yScale: cint
) {.cdecl, importc: "hb_font_set_scale", dynlib: hbLib.}

proc hb_font_get_scale*(
  font: HbFont, xScale, yScale: ptr cint
) {.cdecl, importc: "hb_font_get_scale", dynlib: hbLib.}

proc hb_font_set_ppem*(
  font: HbFont, xPpem, yPpem: cuint
) {.cdecl, importc: "hb_font_set_ppem", dynlib: hbLib.}
...
): HbBool {.cdecl, importc: "hb_font_get_glyph_extents", dynlib: hbLib.}

proc hb_ot_font_set_funcs*(
  font: HbFont
) {.cdecl, importc: "hb_ot_font_set_funcs", dynlib: hbLib.}

proc hb_aat_layout_has_substitution*(
  face: HbFace
): HbBool {.cdecl, importc: "hb_aat_layout_has_substitution", dynlib: hbLib.}

proc hb_aat_layout_has_positioning*(
  face: HbFace
): HbBool {.cdecl, importc: "hb_aat_layout_has_positioning", dynlib: hbLib.}
...
proc hb_buffer_create_similar*(
  src: HbBuffer
): HbBuffer {.cdecl, importc: "hb_buffer_create_similar", dynlib: hbLib.}

proc hb_buffer_get_empty*(): HbBuffer {.
  cdecl, importc: "hb_buffer_get_empty", dynlib: hbLib
.}

proc hb_buffer_reference*(
  buffer: HbBuffer
): HbBuffer {.cdecl, importc: "hb_buffer_reference", dynlib: hbLib.}

proc hb_buffer_destroy*(
  buffer: HbBuffer
) {.cdecl, importc: "hb_buffer_destroy", dynlib: hbLib.}

proc hb_buffer_reset*(
  buffer: HbBuffer
) {.cdecl, importc: "hb_buffer_reset", dynlib: hbLib.}

proc hb_buffer_clear_contents*(
  buffer: HbBuffer
) {.cdecl, importc: "hb_buffer_clear_contents", dynlib: hbLib.}

proc hb_buffer_set_content_type*(
  buffer: HbBuffer, contentType: HbBufferContentType
) {.cdecl, importc: "hb_buffer_set_content_type", dynlib: hbLib.}

proc hb_buffer_get_content_type*(
  buffer: HbBuffer
): HbBufferContentType {.cdecl, importc: "hb_buffer_get_content_type", dynlib: hbLib.}

proc hb_buffer_set_direction*(
  buffer: HbBuffer, direction: HbDirection
) {.cdecl, importc: "hb_buffer_set_direction", dynlib: hbLib.}

proc hb_buffer_get_direction*(
  buffer: HbBuffer
): HbDirection {.cdecl, importc: "hb_buffer_get_direction", dynlib: hbLib.}

proc hb_buffer_set_script*(
  buffer: HbBuffer, script: HbScript
) {.cdecl, importc: "hb_buffer_set_script", dynlib: hbLib.}

proc hb_buffer_get_script*(
  buffer: HbBuffer
): HbScript {.cdecl, importc: "hb_buffer_get_script", dynlib: hbLib.}

proc hb_buffer_set_language*(
  buffer: HbBuffer, language: HbLanguage
) {.cdecl, importc: "hb_buffer_set_language", dynlib: hbLib.}

proc hb_buffer_get_language*(
  buffer: HbBuffer
): HbLanguage {.cdecl, importc: "hb_buffer_get_language", dynlib: hbLib.}

proc hb_buffer_set_segment_properties*(
  buffer: HbBuffer, props: ptr HbSegmentProperties
) {.cdecl, importc: "hb_buffer_set_segment_properties", dynlib: hbLib.}

proc hb_buffer_get_segment_properties*(
  buffer: HbBuffer, props: ptr HbSegmentProperties
) {.cdecl, importc: "hb_buffer_get_segment_properties", dynlib: hbLib.}

proc hb_buffer_guess_segment_properties*(
  buffer: HbBuffer
) {.cdecl, importc: "hb_buffer_guess_segment_properties", dynlib: hbLib.}

proc hb_buffer_set_flags*(
  buffer: HbBuffer, flags: HbBufferFlags
) {.cdecl, importc: "hb_buffer_set_flags", dynlib: hbLib.}

proc hb_buffer_get_flags*(
  buffer: HbBuffer
): HbBufferFlags {.cdecl, importc: "hb_buffer_get_flags", dynlib: hbLib.}

proc hb_buffer_set_cluster_level*(
  buffer: HbBuffer, level: HbBufferClusterLevel
) {.cdecl, importc: "hb_buffer_set_cluster_level", dynlib: hbLib.}

proc hb_buffer_get_cluster_level*(
  buffer: HbBuffer
): HbBufferClusterLevel {.cdecl, importc: "hb_buffer_get_cluster_level", dynlib: hbLib.}

proc hb_buffer_add*(
  buffer: HbBuffer, codepoint: HbCodepoint, cluster: cuint
) {.cdecl, importc: "hb_buffer_add", dynlib: hbLib.}

proc hb_buffer_add_utf8*(
  buffer: HbBuffer, text: cstring, textLength: cint, itemOffset: cuint, itemLength: cint
) {.cdecl, importc: "hb_buffer_add_utf8", dynlib: hbLib.}
...
proc hb_buffer_add_utf32*(
  ...
  itemOffset: cuint,
  itemLength: cint,
) {.cdecl, importc: "hb_buffer_add_utf32", dynlib: hbLib.}
...
proc hb_buffer_add_codepoints*(
  ...
  itemOffset: cuint,
  itemLength: cint,
) {.cdecl, importc: "hb_buffer_add_codepoints", dynlib: hbLib.}

proc hb_buffer_set_length*(
  buffer: HbBuffer, length: cuint
): HbBool {.cdecl, importc: "hb_buffer_set_length", dynlib: hbLib.}

proc hb_buffer_get_length*(
  buffer: HbBuffer
): cuint {.cdecl, importc: "hb_buffer_get_length", dynlib: hbLib.}

proc hb_buffer_get_glyph_infos*(
  buffer: HbBuffer, length: ptr cuint
): ptr UncheckedArray[HbGlyphInfo] {.
  cdecl, importc: "hb_buffer_get_glyph_infos", dynlib: hbLib
.}

proc hb_buffer_get_glyph_positions*(
  buffer: HbBuffer, length: ptr cuint
): ptr UncheckedArray[HbGlyphPosition] {.
  cdecl, importc: "hb_buffer_get_glyph_positions", dynlib: hbLib
.}
...
): HbBool {.cdecl, importc: "hb_shape_full", dynlib: hbLib.}
...
proc hb_set_reference*(
  set: HbSet
): HbSet {.cdecl, importc: "hb_set_reference", dynlib: hbLib.}

proc hb_set_destroy*(set: HbSet) {.cdecl, importc: "hb_set_destroy", dynlib: hbLib.}
proc hb_set_copy*(set: HbSet): HbSet {.cdecl, importc: "hb_set_copy", dynlib: hbLib.}
proc hb_set_clear*(set: HbSet) {.cdecl, importc: "hb_set_clear", dynlib: hbLib.}
proc hb_set_is_empty*(
  set: HbSet
): HbBool {.cdecl, importc: "hb_set_is_empty", dynlib: hbLib.}

proc hb_set_has*(
  set: HbSet, codepoint: HbCodepoint
): HbBool {.cdecl, importc: "hb_set_has", dynlib: hbLib.}

proc hb_set_add*(
  set: HbSet, codepoint: HbCodepoint
) {.cdecl, importc: "hb_set_add", dynlib: hbLib.}

proc hb_set_add_range*(
  set: HbSet, first, last: HbCodepoint
) {.cdecl, importc: "hb_set_add_range", dynlib: hbLib.}

proc hb_set_del*(
  set: HbSet, codepoint: HbCodepoint
) {.cdecl, importc: "hb_set_del", dynlib: hbLib.}

proc hb_set_get_population*(
  set: HbSet
): cuint {.cdecl, importc: "hb_set_get_population", dynlib: hbLib.}

proc hb_set_get_min*(
  set: HbSet
): HbCodepoint {.cdecl, importc: "hb_set_get_min", dynlib: hbLib.}

proc hb_set_get_max*(
  set: HbSet
): HbCodepoint {.cdecl, importc: "hb_set_get_max", dynlib: hbLib.}

proc hb_set_next*(
  set: HbSet, codepoint: ptr HbCodepoint
): HbBool {.cdecl, importc: "hb_set_next", dynlib: hbLib.}

proc hb_subset_input_create_or_fail*(): HbSubsetInput {.
  cdecl, importc: "hb_subset_input_create_or_fail", dynlib: hbSubsetLib
.}

proc hb_subset_input_reference*(
  input: HbSubsetInput
): HbSubsetInput {.cdecl, importc: "hb_subset_input_reference", dynlib: hbSubsetLib.}

proc hb_subset_input_destroy*(
  input: HbSubsetInput
) {.cdecl, importc: "hb_subset_input_destroy", dynlib: hbSubsetLib.}

proc hb_subset_input_keep_everything*(
  input: HbSubsetInput
) {.cdecl, importc: "hb_subset_input_keep_everything", dynlib: hbSubsetLib.}

proc hb_subset_input_unicode_set*(
  input: HbSubsetInput
): HbSet {.cdecl, importc: "hb_subset_input_unicode_set", dynlib: hbSubsetLib.}

proc hb_subset_input_glyph_set*(
  input: HbSubsetInput
): HbSet {.cdecl, importc: "hb_subset_input_glyph_set", dynlib: hbSubsetLib.}

proc hb_subset_input_set*(
  input: HbSubsetInput, setType: HbSubsetSets
): HbSet {.cdecl, importc: "hb_subset_input_set", dynlib: hbSubsetLib.}

proc hb_subset_input_set_flags*(
  input: HbSubsetInput, value: cuint
) {.cdecl, importc: "hb_subset_input_set_flags", dynlib: hbSubsetLib.}

proc hb_subset_input_get_flags*(
  input: HbSubsetInput
): HbSubsetFlags {.cdecl, importc: "hb_subset_input_get_flags", dynlib: hbSubsetLib.}

proc hb_subset_input_pin_axis_location*(
  input: HbSubsetInput, face: HbFace, axisTag: HbTag, axisValue: cfloat
): HbBool {.cdecl, importc: "hb_subset_input_pin_axis_location", dynlib: hbSubsetLib.}

proc hb_subset_preprocess*(
  source: HbFace
): HbFace {.cdecl, importc: "hb_subset_preprocess", dynlib: hbSubsetLib.}

proc hb_subset_or_fail*(
  source: HbFace, input: HbSubsetInput
): HbFace {.cdecl, importc: "hb_subset_or_fail", dynlib: hbSubsetLib.}

proc hb_subset_plan_create_or_fail*(
  face: HbFace, input: HbSubsetInput
): HbSubsetPlan {.cdecl, importc: "hb_subset_plan_create_or_fail", dynlib: hbSubsetLib.}

proc hb_subset_plan_reference*(
  plan: HbSubsetPlan
): HbSubsetPlan {.cdecl, importc: "hb_subset_plan_reference", dynlib: hbSubsetLib.}

proc hb_subset_plan_destroy*(
  plan: HbSubsetPlan
) {.cdecl, importc: "hb_subset_plan_destroy", dynlib: hbSubsetLib.}

proc hb_subset_plan_execute_or_fail*(
  plan: HbSubsetPlan
): HbFace {.cdecl, importc: "hb_subset_plan_execute_or_fail", dynlib: hbSubsetLib.}
